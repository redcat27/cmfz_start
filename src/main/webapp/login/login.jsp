    ...
    <script>
        ...
        $(function () {
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src", "${pageContext.request.contextPath}/security/code?time=" + new Date().getTime());
            });
        });
        ...
        $(function () {
            $("#loginButtonId").click(function () {
                ...
                if(username&&password&&code){
                    ...
                    $("#message").html("<font color='red'>请输入完整信息...</font>");
                }
                        ...
                        <form role="form" action="${pageContext.request.contextPath}/Admin/login" method="post"
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 48px" class="captchaImage"
                                     src="${pageContext.request.contextPath}/security/code">
                                <input style="width: 274px;height: 50px;border:3px solid #ddd;border-radius: 4px; padding: 0 20px;" placeholder="请输入验证码..."
